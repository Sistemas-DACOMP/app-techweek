...
function main() {
  ...
  const results = {
    ...
    codeReview: check('Code Review agent', existsSync(path('.claude/agents/code-review.md'))),
    security: check('Security agent', existsSync(path('.claude/agents/security.md'))),
    qa: check('QA agent', existsSync(path('.claude/agents/qa.md'))),
