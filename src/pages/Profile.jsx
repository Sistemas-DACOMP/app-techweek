  ...
  return (
    <div className="page-container animate-fade-in" style={{ paddingBottom: '120px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '32px' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '6px', textAlign: 'center' }}>
      ...
      <div className="card" style={{ marginBottom: '24px', textAlign: 'center' }}>
        ...
        {profile.symplaTicket?.ticketName ? (
          <div style={{ display: 'inline-block', padding: '4px 12px', background: 'rgba(16, 185, 129, 0.12)', border: '1px solid rgba(16, 185, 129, 0.3)', borderRadius: '20px', color: '#10b981', fontSize: '0.75rem', fontWeight: 'bold', marginBottom: '16px' }}>
            🎟️ {profile.symplaTicket.ticketName} • Confirmado
          </div>
        ) : (
          <div style={{ display: 'inline-block', padding: '4px 12px', background: 'rgba(245, 158, 11, 0.12)', border: '1px solid rgba(245, 158, 11, 0.3)', borderRadius: '20px', color: '#fbbf24', fontSize: '0.75rem', fontWeight: 'bold', marginBottom: '16px' }}>
